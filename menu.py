""" All the code below is from claraj/hello_sqlite_python/peewee_orm/reading_list/menu.py
used to create the set up for menu options displayed in the ui. 
https://github.com/claraj/hello_sqlite_python/blob/master/peewee_orm/reading_list/menu.py """
